...
// Repo-relative paths to the Hermes harness (apps/harness/), kept out of apps/web/ itself.
...
export const HERMES_HARNESS_ROOT = path.join(AIO_REPO_ROOT, "apps", "harness");
...
// apps/harness/CLAUDE.md "stray-write root cause" fix. Both vars MUST be set
