...
--
-- Backward compatible: the existing match_knowledge_chunks(p_customer_id, ...) is
...
CREATE INDEX IF NOT EXISTS hermes_knowledge_chunks_content_tsv_idx
  ON hermes_knowledge_chunks USING gin (to_tsvector('english', content));
