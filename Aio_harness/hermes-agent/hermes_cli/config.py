...
DEFAULT_CONFIG = {
    ...
    "terminal": {
        ...
        # Daytona sandbox network egress control. block_all=True drops all
        # outbound network for the sandbox; allow_list is a comma-separated
        # list of CIDR addresses exempted from the block. Empty/None = no
        # restriction (Daytona default — open egress). Ignored for non-daytona
        # backends.
